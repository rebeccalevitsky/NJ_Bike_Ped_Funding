...
<div style="text-align: center; margin-top: 20px; margin-left: -10%; margin-right: -10%;">
    <img src="countydisttrans.png" 
         alt="County Distribution of TASA Funding" 
         style="width: 110%; max-width: 1600px; height: auto;"/>
...
<div style="text-align: center; margin-top: 20px; margin-left: -10%; margin-right: -10%;">
    <img src="Camdentrans.png" 
         ...
         style="width: 110%; max-width: 1600px; height: auto;"/>
    <p><em>Figure 3: Camden Municipalities that have received TASA funding.</em></p>
</div>
...
<div style="text-align: center; margin-top: 20px; margin-left: -10%; margin-right: -10%;">
    ...
    <p><em>Figure 4: Map showing Bike LTS and TASA funding relationship.</em></p>
</div>
